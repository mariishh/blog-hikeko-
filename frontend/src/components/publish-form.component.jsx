...
const PublishForm = () => {
    ...
    let { userAuth: { access_token } } = useContext(UserContext); // Corrected line
    ...
    const publishBlog = (e) => {
        ...
        if (!des.length || des.length > characterLimit) {
            return toast.error(`Write a description about your post within ${characterLimit} characters to publish`);
        }
        ...
        <AnimationWrapper>
            <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4">
                ...
                <div className="border-grey lg:border-1 lg:pl-8">
                    ...
                    <p className="text-dark-grey mb-2 mt-9">Short description about your experience</p>
                    <textarea
                    ...
                    <p className="text-dark-grey mb-2 mt-9">Topics - (Help is searching and ranking your post)</p>        
